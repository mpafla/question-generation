...
from tensorflow.python.keras.layers import Embedding, Input, Add, Flatten, Bidirectional, CuDNNLSTM, Concatenate, Dense
...
def createModel():
    ...
    encoder_lstm = CuDNNLSTM(LSTM_HIDDEN_STATES, return_state=True)
    ...
    decoder_lstm = CuDNNLSTM(LSTM_HIDDEN_STATES, return_sequences=True, return_state=True)
    decoder_outputs, _, _ = decoder_lstm(decoder_embedding_questions,
...
for epoch in range(EPOCHS):
    ...
    model_path = "models/s2s_lstm{}_epoch{}.h5".format(LSTM_HIDDEN_STATES, epoch)
