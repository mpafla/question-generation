...
model = load_model('models/s2s_lstm512_epoch8.h5')



encoder_inputs = [model.get_layer("input_1").output, model.get_layer("input_2").output]
encoder_outputs, state_h, state_c  = model.get_layer("cu_dnnlstm").output
...
decoder_state_input_h = Input(shape=(LSTM_HIDDEN_STATES,))
decoder_state_input_c = Input(shape=(LSTM_HIDDEN_STATES,))
decoder_states_inputs = [decoder_state_input_h, decoder_state_input_c]
decoder_lstm = model.get_layer("cu_dnnlstm_1")
